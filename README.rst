...
Synopsis
--------
Highly-general utility functions and interfaces for dealing with itemized collections (anything with a __getitem__). These include Mappings (~dicts), and Sequences (~tuples/lists), but are more general.



Unfinished Boilerplate Below
==============================
